...
# 1. Model Decision Tree z domyślnymi parametrami
...
save_results_to_file("decision_tree_label_results.txt", "Decision Tree with default parameters:")
save_results_to_file("decision_tree_label_results.txt", f"Accuracy: {accuracy:.2f}")
save_results_to_file("decision_tree_label_results.txt", f"Precision: {precision:.2f}")
save_results_to_file("decision_tree_label_results.txt", f"Recall: {recall:.2f}")
save_results_to_file("decision_tree_label_results.txt", f"F1 Score: {f1:.2f}")
save_results_to_file("decision_tree_label_results.txt", "\n" + classification_report(y_test_encoded, y_pred))
...
grid_search = GridSearchCV(estimator=dt_model, param_grid=param_grid, cv=5, n_jobs=-1, scoring='f1')
...
# Predykcje na zbiorze testowym z najlepszym modelem
y_pred_best = best_dt_model.predict(X_test_scaled)

# Ocena modelu po optymalizacji
accuracy_best = accuracy_score(y_test_encoded, y_pred_best)
precision_best = precision_score(y_test_encoded, y_pred_best)
recall_best = recall_score(y_test_encoded, y_pred_best)
f1_best = f1_score(y_test_encoded, y_pred_best)

# Zapis wyników do pliku
save_results_to_file("decision_tree_label_results.txt", "\nDecision Tree with optimized parameters:")
save_results_to_file("decision_tree_label_results.txt", f"Best Parameters: {best_params}")
save_results_to_file("decision_tree_label_results.txt", f"Accuracy: {accuracy_best:.2f}")
save_results_to_file("decision_tree_label_results.txt", f"Precision: {precision_best:.2f}")
save_results_to_file("decision_tree_label_results.txt", f"Recall: {recall_best:.2f}")
save_results_to_file("decision_tree_label_results.txt", f"F1 Score: {f1_best:.2f}")
save_results_to_file("decision_tree_label_results.txt", "\n" + classification_report(y_test_encoded, y_pred_best))

print("Decision Tree Classifier for 'label' completed. Results are saved in decision_tree_label_results.txt.")
...
# Zapis wyników do pliku
save_results_to_file("decision_tree_attack_cat_results.txt", "Decision Tree with default parameters:")
save_results_to_file("decision_tree_attack_cat_results.txt", f"Accuracy: {accuracy:.2f}")
save_results_to_file("decision_tree_attack_cat_results.txt", f"Precision: {precision:.2f}")
save_results_to_file("decision_tree_attack_cat_results.txt", f"Recall: {recall:.2f}")
save_results_to_file("decision_tree_attack_cat_results.txt", f"F1 Score: {f1:.2f}")
save_results_to_file("decision_tree_attack_cat_results.txt", "\n" + classification_report(y_test_encoded, y_pred, target_names=le.classes_))
...
# Zapis wyników do pliku
save_results_to_file("decision_tree_attack_cat_results.txt", "\nDecision Tree with optimized parameters:")
save_results_to_file("decision_tree_attack_cat_results.txt", f"Best Parameters: {best_params}")
save_results_to_file("decision_tree_attack_cat_results.txt", f"Accuracy: {accuracy_best:.2f}")
save_results_to_file("decision_tree_attack_cat_results.txt", f"Precision: {precision_best:.2f}")
save_results_to_file("decision_tree_attack_cat_results.txt", f"Recall: {recall_best:.2f}")
save_results_to_file("decision_tree_attack_cat_results.txt", f"F1 Score: {f1_best:.2f}")
save_results_to_file("decision_tree_attack_cat_results.txt", "\n" + classification_report(y_test_encoded, y_pred_best, target_names=le.classes_))

print("Decision Tree Classifier for 'attack_cat' completed. Results are saved in decision_tree_attack_cat_results.txt.")